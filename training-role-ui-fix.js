/* V86.46.31 — separate member/leader training labels and hide question management from members without mutation loops */
(function(){
  if(window.__DXN_TRAINING_ROLE_UI_FIX_V864631__)return;
  window.__DXN_TRAINING_ROLE_UI_FIX_V864631__=true;
  ...
  function renameTrainingTab(role){
    ...
    document.querySelectorAll('.tabs .tab').forEach(function(tab){
      ...
      if(tab.getAttribute('aria-label')!==aria){
  ...
  function removeMemberQuestionManager(){
    ...
    document.querySelectorAll('.dxn-training-manage-modal [data-ideal],.dxn-training-manage-modal [data-edit],.dxn-training-manage-modal [data-delete]').forEach(function(btn){
