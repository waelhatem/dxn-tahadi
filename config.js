...
/* V86.46.3 — question-admin is leader-only; opens directly from Smart Leader Center. */
(function(){
...
(function(){
  ...
  function loadLeaderAdmin(){load('training-question-admin.js?v=86.46.10')}
