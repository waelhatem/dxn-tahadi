...
function open3d(d){
  ...
  overlay.innerHTML='<div class="ragwan3dbox"><div class="ragwan3dtop"><div><span class="ragwan3dnum">'+n+'</span>'+title+'</div><button class="ragwan3dclose" type="button">×</button></div><model-viewer class="ragwan3dviewer" src="'+MODEL+'" camera-orbit="0deg 76deg 8.2m" camera-target="0m 1.3m 0m" field-of-view="28deg" interaction-prompt="none" disable-pan disable-tap shadow-intensity="0.45" exposure="1.65" tone-mapping="aces" environment-image="neutral" loading="eager"></model-viewer><div class="ragwan3dbottom"><div class="ragwan3dstatus">جارٍ تحميل الباب...</div></div></div>';
