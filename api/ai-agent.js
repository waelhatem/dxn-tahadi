...
function instructions(context){
  return [
    ...
    'قاعدة التحية الشخصية: إذا كانت رسالة العضو تحية أو افتتاحًا اجتماعيًا قصيرًا مثل «هلا»، «مرحبا»، «السلام عليكم»، «شلونك» أو ما شابه، ابدأ ردك مباشرة باسم العضو: «هلا [اسم العضو] ...» أو صياغة عراقية طبيعية تتضمن اسمه في أول الجملة. لا تكتفِ بـ«هلا بيك» أو «هلا والله» من دون الاسم.',
