/* V86.46.25 — leader-only training-question editor launcher + guaranteed sub-tab under Lessons & Training */
(function(){
  if(window.__DXN_TRAINING_QUESTION_ADMIN_HOTFIX_V864625__)return;
  window.__DXN_TRAINING_QUESTION_ADMIN_HOTFIX_V864625__=true;
  ...
  function removeOldUI(){
    ['dxn-training-question-admin-center-button','dxn-qadmin-page-bottom','dxn-training-question-admin-direct-panel','dxn-training-question-admin-tab'].forEach(function(id){var e=document.getElementById(id);if(e)e.remove()});
      ...
      loadEditorScript(function(err){
        ...
        try{
          if(typeof window.openTrainingQuestionAdmin==='function'){
            ...
            setActive('questions');
            setTimeout(function(){var r=document.getElementById('dxn-training-question-admin');if(r){p.style.display='none';r.style.display='block';r.scrollIntoView({behavior:'smooth',block:'start'})}},100);
          }
        }catch(e){}
      });
      return true;
  ...
  var tries=0,t=setInterval(function(){install();if(++tries>720)clearInterval(t)},250);
